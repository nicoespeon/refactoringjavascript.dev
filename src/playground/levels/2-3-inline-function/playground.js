function createGame(console) {
  return function Game() {
    ...
    function pushWithSuffix(array, elt, suffix) {
      array.push(elt + " " + suffix);
    }
    ...
    for (var i = 0; i < 50; i++) {
      pushWithSuffix(popQuestions, "Pop Question", i);
      pushWithSuffix(scienceQuestions, "Science Question", i);
      pushWithSuffix(sportsQuestions, "Sports Question", i);
