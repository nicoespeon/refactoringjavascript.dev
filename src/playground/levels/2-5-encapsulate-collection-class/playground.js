  ...
  return function Game() {
    ...
    var askQuestion = function () {
      if (currentCategory() == "Pop") {
        console.log(questions.pop[0]);
        questions.pop.shift();
      }
      if (currentCategory() == "Science") {
        console.log(questions.science[0]);
        questions.science.shift();
      }
      if (currentCategory() == "Sports") {
        console.log(questions.sports[0]);
        questions.sports.shift();
      }
      if (currentCategory() == "Rock") {
        console.log(questions.rock[0]);
        questions.rock.shift();
      }
    };
